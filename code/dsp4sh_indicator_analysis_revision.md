...
![](dsp4sh_indicator_analysis_revision_files/figure-gfm/Figure%201%20map%20of%20DSP4SH%20sites-1.png)<!-- -->
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/Table 1 dsp4sh project overview table-1.png" width="913" />
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/range of environmental characteristics across all sites-1.png" width="410" />
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/range in indicator values across all sites-1.png" width="1893" />
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/range in indicator values in reference sites only-1.png" width="1893" />
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/range in surface soil clay content and bulk density-1.png" width="492" />
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/range in surface soil clay content and bulk density-2.png" width="451" />
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/Table S1 mean indicator values in all systems-1.png" width="8789" />
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/range in mean indicator values across projects-1.png" width="1047" />
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/cv for overall dataset grouped by indicator-1.png" width="972" />
...
![](dsp4sh_indicator_analysis_revision_files/figure-gfm/Figure%20S1%20correlation%20matrix-1.png)<!-- -->
...
![](dsp4sh_indicator_analysis_revision_files/figure-gfm/plot%20pca%20results-1.png)<!-- -->
...
![](dsp4sh_indicator_analysis_revision_files/figure-gfm/plot%20pca%20results-2.png)<!-- -->
...
![](dsp4sh_indicator_analysis_revision_files/figure-gfm/plot%20pca%20results-3.png)<!-- -->
...
![](dsp4sh_indicator_analysis_revision_files/figure-gfm/plot%20pca%20results-4.png)<!-- -->
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/permanova-1.png" width="1141" />
...
![](dsp4sh_indicator_analysis_revision_files/figure-gfm/Figure%202%20PCA-1.png)<!-- -->
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/top models for each indicator - ref sites-1.png" width="1340" />
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/table s3 coefficients for all lms-1.png" width="1091" />
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/table s3 coefficients for all lms-2.png" width="1639" />
...
![](dsp4sh_indicator_analysis_revision_files/figure-gfm/Figure%203%20feature%20importance-1.png)<!-- -->
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/feature importance ranking-1.png" width="1270" />

# Use meta-analysis methods to determine indicator sensitivity to management across all projects

Treat the DSP4SH database like a meta-analysis and use functions in the
metafor() package to calculate the effect size of SHM and Ref treatments
on soil health indicators. This version of the analysis uses data that
is slightly altered from what cooperators originally provided - the
names of some treatments have been changed to combine treatments that
are reasonably similar for accurate effect size calculation.
...
![](dsp4sh_indicator_analysis_revision_files/figure-gfm/forest%20plots%20and%20table%20of%20significant%20indicators-1.png)<!-- -->

    ## 
    ## [[2]]

![](dsp4sh_indicator_analysis_revision_files/figure-gfm/forest%20plots%20and%20table%20of%20significant%20indicators-2.png)<!-- -->

    ## 
    ## [[3]]

![](dsp4sh_indicator_analysis_revision_files/figure-gfm/forest%20plots%20and%20table%20of%20significant%20indicators-3.png)<!-- -->

    ## 
    ## [[4]]

![](dsp4sh_indicator_analysis_revision_files/figure-gfm/forest%20plots%20and%20table%20of%20significant%20indicators-4.png)<!-- -->

    ## 
    ## [[5]]

![](dsp4sh_indicator_analysis_revision_files/figure-gfm/forest%20plots%20and%20table%20of%20significant%20indicators-5.png)<!-- -->

    ## 
    ## [[6]]

![](dsp4sh_indicator_analysis_revision_files/figure-gfm/forest%20plots%20and%20table%20of%20significant%20indicators-6.png)<!-- -->

    ## 
    ## [[7]]

![](dsp4sh_indicator_analysis_revision_files/figure-gfm/forest%20plots%20and%20table%20of%20significant%20indicators-7.png)<!-- -->

    ## 
    ## [[8]]

![](dsp4sh_indicator_analysis_revision_files/figure-gfm/forest%20plots%20and%20table%20of%20significant%20indicators-8.png)<!-- -->

    ## 
    ## [[9]]

![](dsp4sh_indicator_analysis_revision_files/figure-gfm/forest%20plots%20and%20table%20of%20significant%20indicators-9.png)<!-- -->

    ## 
    ## [[10]]

![](dsp4sh_indicator_analysis_revision_files/figure-gfm/forest%20plots%20and%20table%20of%20significant%20indicators-10.png)<!-- -->

    ## 
    ## [[11]]

![](dsp4sh_indicator_analysis_revision_files/figure-gfm/forest%20plots%20and%20table%20of%20significant%20indicators-11.png)<!-- -->

    ## 
    ## [[12]]

![](dsp4sh_indicator_analysis_revision_files/figure-gfm/forest%20plots%20and%20table%20of%20significant%20indicators-12.png)<!-- -->
...
![](dsp4sh_indicator_analysis_revision_files/figure-gfm/Figure%204%20effect%20sizes-1.png)<!-- -->
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/table with observation n for random-effects models-1.png" width="628" />
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/table s4 summary of random effects models-1.png" width="1992" />
...
moderating variables of interest are MAT, MAP, and soil clay content.
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/random effects model with mat as a moderator variable-1.png" width="2513" />
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/random effects model with mat as a moderator variable-2.png" width="2391" />
...
![](dsp4sh_indicator_analysis_revision_files/figure-gfm/Figure%20S14%20mat%20mod-1.png)<!-- -->
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/random effects model with map as a moderator variable-1.png" width="2513" />
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/random effects model with map as a moderator variable-2.png" width="2508" />
...
![](dsp4sh_indicator_analysis_revision_files/figure-gfm/Figure%20S15%20map%20mod-1.png)<!-- -->
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/random effects model with clay as a moderator variable-1.png" width="2513" />
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/random effects model with clay as a moderator variable-2.png" width="2513" />
...
![](dsp4sh_indicator_analysis_revision_files/figure-gfm/Figure%20S16%20clay%20mod-1.png)<!-- -->
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/table s5 significant moderator variables-1.png" width="1714" />
...
<img src="dsp4sh_indicator_analysis_revision_files/figure-gfm/table s6 SHAPE score summary table-1.png" width="804" />
...
![](dsp4sh_indicator_analysis_revision_files/figure-gfm/Figure%205%20SHAPE%20boxplot-1.png)<!-- -->
...
![](dsp4sh_indicator_analysis_revision_files/figure-gfm/Figure%205%20SHAPE%20boxplot-2.png)<!-- -->
